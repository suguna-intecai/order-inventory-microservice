...
export const getInventory = async (call, callback) => {
    try {
...
export const checkStock = async (call, callback) => {
    try {
...
export const reserveStock = async (call, callback) => {
    try {
        const { productId, quantity } = call.request;
...
export const releaseStock = async (call, callback) => {
    try {
        const { productId, quantity } = call.request;
        ...
        callback({
            ...
            message: error instanceof Error ? error.message : "Unable to release stock",
        });
    }
};
